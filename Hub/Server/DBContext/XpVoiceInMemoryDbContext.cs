...
namespace Hub.Server.DBContext
{

    public partial class XpVoiceInMemoryDbContext : DbContext
    {
        ...
        public XpVoiceInMemoryDbContext(DbContextOptions<XpVoiceInMemoryDbContext> options)
            : base(options)
        {
